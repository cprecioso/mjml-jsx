declare type VoA<T> = T[] | T;
declare type Children = VoA<JSX.Element | string | null>[];
declare type JSXChildren = VoA<JSX.Element | null>;
export declare function jsx(tagName: string, attributes: {}, ...children: Children): JSX.Element;
declare type ElementProperties = {
    mjml: {
        /**
...
declare type AllPossibleProperties = UnionToIntersection<ElementProperties[keyof ElementProperties]>;
declare type CatchAllElementProperties = Record<"mj-class" | "mj-all", Partial<AllPossibleProperties>>;
declare type _IntrinsicElements = ElementProperties & CatchAllElementProperties;
declare global {
    namespace JSX {
        interface Element {
            tagName: string;
